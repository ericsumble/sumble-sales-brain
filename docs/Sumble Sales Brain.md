...
- **Open:** salutation goes directly to the pitch — no "Welcome aboard" / "Welcome back" warm-receipt line. The signal-mapped play earns attention faster than a greeting (ratified 2026-05-13).
...
**No warm-receipt openers.** Drop "Welcome aboard." / "Welcome back." / "Saw you in this week." Salutation goes directly to the pitch — the signal-mapped play does the warmth work better and saves ~10 words of the 100-word budget. Ratified 2026-05-13 after reviewing the first 26 inbound intros generated by the leads tracker. For re-engagement (follow-up #1 in [[leads-tracker]] cadence), open with `Wanted to circle back since [date].` — that's a context signal, not warm receipt.
